...
We see that Brooklyn has the highest amount of rats, followed by Manhattan, the Bronx, Queens, and Staten Island. Running a one-way ANOVA test on the number of monthly rat sightings by borough, we see that the p-value is `r test_borough %>% pull(p.value)` and at least one of the borough means is not equal to the others.
